...
class WarehousePolicy
{
    ...
    {
        return $user->role->hasPermissions("show-warehouse");
    }
    ...
    {
        return $user->role->hasPermissions("create-warehouse");
    }
    ...
    {
        return $user->role->hasPermissions("update-warehouse");
    }
    ...
    {
        return $user->role->hasPermissions("delete-warehouse");
    }
