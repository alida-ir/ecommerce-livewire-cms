            ...
            <div class="intro-y box p-5">
                <form wire:submit.prevent="edit">
                    <div>
                        ...
                        <div class="mt-2">
                            <select wire:model.defer="warehouse.product_id" class="w-full">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-2">
                            <input wire:model.defer="warehouse.color" value="{{ $warehouse->color }}" class="input w-full border mt-2">
                        </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-2">
                            <input wire:model.defer="warehouse.hex" value="{{ $warehouse->hex }}" class="input w-full border mt-2">
                        </div>
                        @error('warehouse.hex')
                        <div style="font-size: 12px" class="mt-3 rounded-md flex items-center px-5 py-4 mb-2 bg-theme-6 text-white">
                            <i data-feather="alert-octagon" class="w-6 h-6 ml-2"></i> {{ $message }} </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-2">
                            <input wire:model.defer="warehouse.size"  value="{{ $warehouse->size  }}"  class="input w-full border mt-2">
                        </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-2">
                            <input type="number" wire:model.defer="warehouse.quantity"  value="{{ $warehouse->quantity }}"  class="input w-full border mt-2">
                        </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-2">
                            <input type="number" wire:model.defer="warehouse.price"  value="{{ $warehouse->price }}"  class="input w-full border mt-2">
                        </div>
