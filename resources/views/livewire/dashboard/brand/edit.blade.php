            ...
            <div class="intro-y box p-5">
                <form wire:submit.prevent="edit">
                    <div class="mt-3">
                        ...
                        <input type="text" wire:model.defer="brand.title" value="{{$brand->title}}" class="input w-full border mt-2">
                        @error('brand.title')
                    ...
                    <div class="mt-3">
                        <label>برچسب برند</label>
                        <input type="text" wire:model.defer="brand.label" value="{{$brand->label}}" class="input w-full border mt-2">
                        @error('brand.label')
                        <div style="font-size: 12px" class="mt-3 rounded-md flex items-center px-5 py-4 mb-2 bg-theme-6 text-white">
                            <i data-feather="alert-octagon" class="w-6 h-6 ml-2"></i> {{ $message }} </div>
                        @enderror
