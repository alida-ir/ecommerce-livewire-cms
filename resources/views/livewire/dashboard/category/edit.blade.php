            ...
            <div class="intro-y box p-5">
                <form wire:submit.prevent="edit">
                    <div class="mt-3">
                        ...
                        <input type="text" wire:model.defer="category.title" value="{{$category->title}}" class="input w-full border mt-2">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" wire:model.defer="category.label" value="{{$category->label}}" class="input w-full border mt-2">
...
{{--                            <i data-feather="alert-octagon" class="w-6 h-6 ml-2"></i> {{ $message }} </div>--}}
                    ...
                    <div class="mt-5">
                        ...
                        @if($photo instanceof \App\Models\Photo)
                            <img src="{{ $photo->path }}" />
                        @else
