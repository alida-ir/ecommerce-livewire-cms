            ...
            <div class="intro-y box p-5">
                <form wire:submit.prevent="create">
                    <div>
                        ...
                        <input type="text" wire:model.defer="permission.title" class="input w-full border mt-2">
                    ...
                    <div class="mt-3">
                        <label>برچسب</label>
                        <input type="text" wire:model.defer="permission.label" class="input w-full border mt-2">
