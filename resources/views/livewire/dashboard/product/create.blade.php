    ...
    <div class="grid grid-cols-12 gap-6 mt-5 mx-auto">
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="intro-y box p-5">
                <form wire:submit.prevent="create" class="grid grid-cols-12 gap-12 mt-5 mx-auto" data-file-types="image/jpeg|image/png|image/jpg" enctype="multipart/form-data">
                    <div class="col-span-12 lg:col-span-6">
                        <label>نام محصول</label>
                        <input type="text" wire:model.defer="product.name" class="input w-full border mt-2">
                        @error('product.name')
                    ...
                    <div wire:ignore class="mt-5 flex col-span-12 lg:col-span-6" style="flex-direction: column">
                        ...
                        <textarea
                            ...
                            wire:key="ckEditor"
                            x-ref="ckEditor"
                            name="editor1" id="editor" class="ProductContent input w-full border mt-2"></textarea>
                    ...
                    <div class="mt-3 col-span-12 lg:col-span-6">
                        ...
                        <div wire:ignore class="mt-2">
                            <select id="categorySelect" data-placeholder="یک مورد را انتخاب کنید" class=" w-full" multiple>
                    ...
                    <div class="mt-5 col-span-12 lg:col-span-6">
                        ...
                        <input type="text" wire:model.defer="product.price" class="input w-full border mt-2">
                        @error('product.price')
                        <div style="font-size: 12px" class="mt-3 rounded-md flex items-center px-5 py-4 mb-2 bg-theme-6 text-white">
                            <i data-feather="alert-octagon" class="w-6 h-6 ml-2"></i> {{ $message }} </div>
                        @enderror
                            ...
                            <div class="p-5" id="multiple-file-upload">
                                <div class="preview">
                                    <div class="fallback">
                                        ...
                                        @enderror
                                        <div class="text-left">
                                            <button wire:click="upload" type="button" class="button w-24 bg-theme-1 text-white" >آپلود</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
{{--                                        <div class="text-gray-600 text-xs text-center">1 KB</div>--}}
                    ...
                    <div wire:loading><p style="color: #444;margin: 15px 0;">در حال ایجاد محصول ...</p></div>
